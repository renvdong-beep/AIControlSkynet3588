...
// 移除 Qt 依赖，使用 printf 替代 qDebug
#define LOGD printf
// #define LOGD

#define qDebug() printf("[MppDecoder] ")
...
{
    LOGD("MppDecoder Init: video_type=%d, fps=%d\n", video_type, fps);
    MPP_RET ret         = MPP_OK;
...
//    mpp_param1 = &need_split;
//    ret = mpp_mpi->control(mpp_ctx,mpi_cmd,mpp_param1);
        ...
        do {
            ...
            if (frame) {
               ...
               if (mpp_frame_get_info_change(frame)) {
                    //qDebug()<<"mpp_frame_get_info_change************************************";
            ...
            //        LOGD("decode_get_frame get info changed found ");
                    ...
                    //qDebug()<<"this->last_frame_time_ms************************************"<<this->last_frame_time_ms;
                } else{
                    ...
                    if (callback != nullptr) {
                        ...
                        callback(this->userdata, hor_stride, ver_stride, hor_width, ver_height, format, fd, data_vir,this->m_PUser,m_call_Back_ShowInQt);
                        //qDebug()<<"this->userdata:  "<<this->userdata<<" hor_stride:"<<hor_stride<<"  ver_stride:"<<ver_stride<<"   hor_width:"<<hor_width<<"  ver_height:"<<ver_height;
//                        if(m_call_Back_ShowInQt)
//                        {
////                            m_call_Back_ShowInQt(0,(uchar*)(this->userdata),this->m_PUser);
//                             m_call_Back_ShowInQt(0,(uchar*)(data_vir),this->m_PUser);
//                        }
...
int MppDecoder::SetCallback_ToQt(ShowImageCallBack _call_Back_ShowInQt,void*_user){
    m_call_Back_ShowInQt=_call_Back_ShowInQt;
    m_PUser = _user;
    return 1;
}
